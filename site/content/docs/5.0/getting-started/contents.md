  ...
  <tbody>
    <tr>
      <th scope="row">
        ...
        <div><code class="font-weight-normal text-nowrap">bootstrap.rtl.css</code></div>
        <div><code class="font-weight-normal text-nowrap">bootstrap.min.css</code></div>
        <div><code class="font-weight-normal text-nowrap">bootstrap.rtl.min.css</code></div>
      </th>
      <td>Included</td>
      <td>Included</td>
      <td>Included</td>
    ...
    <tr>
      <th scope="row">
        ...
        <div><code class="font-weight-normal text-nowrap">bootstrap-grid.rtl.css</code></div>
        <div><code class="font-weight-normal text-nowrap">bootstrap-grid.min.css</code></div>
        <div><code class="font-weight-normal text-nowrap">bootstrap-grid.rtl.min.css</code></div>
      </th>
    ...
    <tr>
      <th scope="row">
        ...
        <div><code class="font-weight-normal text-nowrap">bootstrap-utilities.rtl.css</code></div>
        <div><code class="font-weight-normal text-nowrap">bootstrap-utilities.min.css</code></div>
        <div><code class="font-weight-normal text-nowrap">bootstrap-utilities.rtl.min.css</code></div>
      </th>
      <td class="text-muted">&mdash;</td>
      <td class="text-muted">&mdash;</td>
      <td class="text-muted">&mdash;</td>
    ...
    <tr>
      <th scope="row">
        ...
        <div><code class="font-weight-normal text-nowrap">bootstrap-reboot.rtl.css</code></div>
        <div><code class="font-weight-normal text-nowrap">bootstrap-reboot.min.css</code></div>
        <div><code class="font-weight-normal text-nowrap">bootstrap-reboot.rtl.min.css</code></div>
      </th>
      <td class="text-muted">&mdash;</td>
